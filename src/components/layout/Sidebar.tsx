...
export const Sidebar = () => {
  ...
  return (
    <aside
      className={cn(
        'bg-card fixed top-0 left-0 z-40 h-screen border-r transition-all duration-300 ease-in-out lg:translate-x-0',
        isSidebarOpen
          ? 'w-64 translate-x-0'
    ...
    >
      {/* Logo */}
      <div className='mb-2 flex h-20 items-center justify-center px-4'>
      ...
      <div className='absolute bottom-6 left-0 w-full px-6'>
        <div
          className={cn(
            'rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 dark:border-blue-900/50 dark:from-blue-950/30 dark:to-indigo-950/30',
