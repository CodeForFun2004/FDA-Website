...
export const mockAreas: AreaDto[] = [
  ...
  },
  {
    ...
    longitude: 108.23785,
    radiusMeters: 1000,
    addressText: 'Ngu Hanh Son district monitoring stations',
    stationIds: [
  ...
  },
  {
    ...
    longitude: 108.226,
    radiusMeters: 800,
    addressText: 'Lien Chieu district and Hue Junction area',
    stationIds: [
  ...
  },
  {
    ...
    longitude: 108.22,
    radiusMeters: 600,
    addressText: 'Central Hai Chau district monitoring stations',
    stationIds: [
  ...
  },
  {
    ...
    name: 'Lien Tri & Thanh Ha',
    latitude: 16.048,
    longitude: 108.215,
    radiusMeters: 700,
    addressText: 'Lien Tri and Thanh Ha bridge areas',
    stationIds: [
  ...
  },
  {
    ...
    name: 'Binh Thuan & Cam Che',
    latitude: 16.042,
    longitude: 108.225,
    radiusMeters: 750,
    addressText: 'Binh Thuan and Cam Che bridge areas',
    stationIds: [
...
export const mockStations: Array<{
...
}> = [
  {
    ...
    locationDesc: 'Tran Phu Street, Hai Chau district',
    latitude: 16.06,
    longitude: 108.23,
    roadName: 'Tran Phu Street',
  ...
  },
  {
    ...
    code: 'ST001',
    name: 'Bach Dang Station',
    locationDesc: 'Near Dragon Bridge, Bach Dang Street',
    latitude: 16.0544,
    longitude: 108.2225,
    roadName: 'Bach Dang Street',
    direction: 'upstream',
    status: 'active',
  ...
  },
  {
    ...
    code: 'ST_DN_NHS_09',
    name: 'Ngu Hanh Son Traffic Monitoring Station',
    locationDesc: 'Near Tien Son Bridge, Chuong Duong area',
    latitude: 16.03552,
    longitude: 108.23785,
    roadName: 'Chuong Duong Street',
    direction: 'upstream',
    status: 'active',
  ...
  },
  {
    ...
    latitude: 16.0592,
    longitude: 108.226,
    roadName: 'Hue Junction',
    direction: 'Toward Han River Bridge',
    status: 'active',
  ...
  },
  {
    ...
    code: 'ST_DN_HC_01',
    name: 'Hai Chau Monitoring Station',
    locationDesc: 'Central Hai Chau district area',
    latitude: 16.067,
    longitude: 108.22,
    roadName: 'Nguyen Van Linh Street',
  ...
  },
  {
    ...
    code: 'ST_DN_LT_01',
    name: 'Lien Tri Monitoring Station',
    locationDesc: 'Located in Lien Tri area, Da Nang',
    latitude: 16.048,
    longitude: 108.215,
    roadName: 'Lien Tri Street',
    direction: 'downstream',
    status: 'active',
  ...
  },
  {
    ...
    code: 'ST_DN_TH_01',
    name: 'Thanh Ha Monitoring Station',
    locationDesc: 'Thanh Ha Bridge area, Da Nang',
    latitude: 16.052,
    longitude: 108.21,
    roadName: 'Thanh Ha Street',
    direction: 'upstream',
    status: 'offline',
    thresholdWarning: null,
    thresholdCritical: null,
  ...
  },
  {
    ...
    code: 'ST_DN_BT_01',
    name: 'Binh Thuan Monitoring Station',
    locationDesc: 'Located in Binh Thuan area, Da Nang',
    latitude: 16.042,
    longitude: 108.225,
    roadName: 'Binh Thuan Street',
    direction: 'bidirectional',
    status: 'active',
  ...
  },
  {
    ...
    code: 'ST_DN_CC_01',
    name: 'Cam Che Monitoring Station',
    locationDesc: 'Cam Che Bridge area, Da Nang',
    latitude: 16.028,
    longitude: 108.24,
    roadName: 'Cam Che Street',
    direction: 'downstream',
    status: 'active',
